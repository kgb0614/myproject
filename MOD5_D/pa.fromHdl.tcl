...
create_project -name MOD5_D -dir "C:/usr/FPGA3/MOD5_D/planAhead_run_1" -part xc6slx9tqg144-3
set_param project.pinAheadLayout yes
set srcset [get_property srcset [current_run -impl]]
set_property target_constrs_file "Mod5_D.ucf" [current_fileset -constrset]
...
set_property file_type Verilog $hdlfile
set_property library work $hdlfile
set hdlfile [add_files [list {Mod5_D.vf}]]
set_property file_type Verilog $hdlfile
set_property library work $hdlfile
set_property top Mod5_D $srcset
add_files [list {Mod5_D.ucf}] -fileset [get_property constrset [current_run]]
