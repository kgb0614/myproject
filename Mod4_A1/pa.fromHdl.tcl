...
create_project -name Mod4_A1 -dir "C:/usr/FPGA3/Mod4_A1/planAhead_run_1" -part xc6slx9tqg144-3
set_param project.pinAheadLayout yes
set srcset [get_property srcset [current_run -impl]]
set_property target_constrs_file "Mod4_A1.ucf" [current_fileset -constrset]
...
set_property file_type Verilog $hdlfile
set_property library work $hdlfile
set hdlfile [add_files [list {Mod4_A1.vf}]]
set_property file_type Verilog $hdlfile
set_property library work $hdlfile
set_property top Mod4_A1 $srcset
add_files [list {Mod4_A1.ucf}] -fileset [get_property constrset [current_run]]
